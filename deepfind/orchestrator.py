...
WORKER_PROMPT = (
    ...
    "video/audio, call youtube_transcribe with the URL or video ID before summarizing. If subtitles are empty or the "
    "task needs the exact spoken content, call youtube_audio_transcribe with the URL plus a short query; use "
    "youtube_audio_transcribe_full only when you truly need the raw transcript. If the latest user request "
