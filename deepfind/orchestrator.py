...
WORKER_PROMPT = (
    ...
    "Prefer boss_detail before messaging because it may already reveal the company. If the task mentions Bilibili "
    "video/audio, call bili_transcribe with the URL or BVID before summarizing. If the task mentions YouTube "
